<template>
    <div class='note'> 
      <div class ="row">
      <h3 class="col-10">{{contact.name}}</h3> 
      <v-speed-dial
        v-model="fab"
        :top="true"
        :right="true"
